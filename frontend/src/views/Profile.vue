        ...
        <div class="mt-3 text-center">
          ...
          <form @submit.prevent="updateProfile" class="mt-2">
            <div class="mt-4">
              ...
              <input type="text" id="firstname" v-model="user.firstname" required class="mt-1 p-2 w-full border-gray-300 rounded-md">
            </div>
            <div class="mt-4">
              <label for="lastname" class="block text-sm font-medium text-gray-700">Nom:</label>
              <input type="text" id="lastname" v-model="user.lastname" required class="mt-1 p-2 w-full border-gray-300 rounded-md">
            </div>
            <div class="mt-4">
              <label for="email" class="block text-sm font-medium text-gray-700">Email:</label>
              <input type="email" id="email" v-model="user.email" required class="mt-1 p-2 w-full border-gray-300 rounded-md">
            </div>
            <div class="mt-6">
